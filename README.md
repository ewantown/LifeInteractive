...
### Intention:
The game itself ought to be fun, of course, but the program was/is a "sandbox". As a result there are a number of boolean "toggles" in the code; e.g. toggling 'devMode' in the NavPanel class will add a 'surprise' button to the menus, which runs (one's choice of) additional code. 
